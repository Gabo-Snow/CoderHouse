...
namespace SistemaGestionData
{
    public static class ProductoVendidoData
    {
        public static List<ProductoVendido> ObtenerProductoVendido(int idProductoVendido)
        {
            ...
            using (SqlConnection conexion = ConexionADO.GetConexion()) // se reemplaza el "string connectionString" con la clase ConexionADO que hace lo mismo y así es más fácil cambiar la conexión
            {
                //conexion.Open();
